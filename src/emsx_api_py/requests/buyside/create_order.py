...
# Optional parameters
class CreateOrderOptional(TypedDict, total=False):
    emsx_account              : NotRequired[str]        # "TestAccount"
    emsx_bookname             : NotRequired[str]        # "BookName"
    emsx_broker               : NotRequired[str]        # "CLSA"
...
def create_order(
        ...
        *,
        ...
        # Optional parameters
        **kwargs: Unpack[CreateOrderOptional]
) -> blpapi.Request:
    """
    ...
    Args:
        ...
        emsx_ticker:
        emsx_amount:
        emsx_order_type: 'MKT', 'LMT', etc. See EMSX API documentation for details.
        emsx_side: 'BUY', 'SELL', 'SHRT', 'COVR', 'B/O', 'B/C', 'S/O', 'S/C'
        emsx_tif:
        emsx_hand_instruction:
        **kwargs: Optional parameters. See `CreateOrderOptional` TypedDict for details.

    Returns: ``blpapi.Request`` object for 'CreateOrder' request with provided parameters set.
