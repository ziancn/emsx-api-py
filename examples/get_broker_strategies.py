"""
This example gets available strategies for a given broker and asset class.
"""
...
from emsx_api_py.requests.buyside.get_broker_strategies_with_asset_class import get_broker_strategies_with_asset_class
...
def main():
    ...
    new_request = get_broker_strategies_with_asset_class(
        service_opened,
        emsx_broker="CLET",
        asset_class="EQTY"
    )
