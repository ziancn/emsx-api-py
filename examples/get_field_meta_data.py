"""
This example gets metadata of a given EMSX field.
"""
...
from emsx_api_py.requests.buyside.get_field_meta_data import get_field_meta_data
...
def main():
    ...
    new_request = get_field_meta_data(
        service_opened,
        fields = ["EMSX_ORDER_TYPE", "EMSX_HAND_INSTRUCTION"]
    )
