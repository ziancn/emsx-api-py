"""
This example send requests to query info of strategy provided by broker.
"""
...
from emsx_api_py.requests.buyside.get_broker_strategy_info_with_asset_class import get_broker_strategy_info_with_asset_class
...
def main():
    ...
    new_request = get_broker_strategy_info_with_asset_class(
        service_opened,
        emsx_broker="CGAG",
        asset_class="EQTY",
        strategy="PART"
